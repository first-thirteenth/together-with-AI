...
export const Home = () => {
  ...
  return (
    <>
      {/* ─── MOBILE layout: normal document flow, no scroll tricks ─── */}
      <div className="lg:hidden bg-cream-bg dark:bg-emerald-luxury text-luxury-text dark:text-cream-bg transition-colors duration-500 relative z-10">
        <AnimatedBackground />
        <section className="max-w-7xl mx-auto px-4 sm:px-6 w-full pt-28 pb-12">
          <motion.div
            initial="hidden"
            animate="visible"
          ...
          {/* Quiz: fully visible, static, in normal flow */}
          <motion.div
            initial="hidden"
            animate="visible"
            variants={fromRight}
