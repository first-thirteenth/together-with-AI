          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center w-full relative">
            ...
            >
              ...
              >
                ...
                {/* Title rises from below with blur */}
                <motion.h1
                  variants={fromBelow}
                  className="text-2xl sm:text-4xl lg:text-6xl font-extrabold tracking-tight leading-tight text-emerald-luxury dark:text-cream-bg transition-colors duration-500"
                >
                  {t.home.titlePre}{" "}
            ...
            {/* Right column: entrance from right, then scroll-driven on mobile + breathing */}
            <motion.div
              initial="hidden"
              animate="visible"
              variants={fromRight}
              className="relative justify-self-center lg:justify-self-end w-full max-w-md mt-2 lg:mt-0 z-10"
            >
              <motion.div
                style={{
